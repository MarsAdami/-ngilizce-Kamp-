...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Geç") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Oto-ilerle") action Preference("auto-forward", "toggle")
            textbutton _("Kaydet") action ShowMenu('save')
            textbutton _("Hızlı-Kayıt") action QuickSave()
...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Tekrarı Bitir") action EndReplay(confirm=True)
        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("Boş kayıt yeri")):
            ...
            hbox:
                ...
                if config.has_autosave:
                    textbutton _("{#auto_page}A") action FilePage("Otomatik")

                if config.has_quicksave:
                    textbutton _("{#quick_page}Q") action FilePage("Hızlı")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Zamanı otomatik ileri sar")
    ...
    use game_menu(_("Yardım"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                if GamepadExists():
                    textbutton _("Oyun Kolu") action SetScreenVariable("device", "gamepad")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Diyaloğu ilerletir ve arayüzü etkinleştirir.")

    hbox:
        label _("Boşluk")
        text _("Seçenekleri seçmeden diyalogu ilerletir.")

    hbox:
        label _("Yön Tuşları")
        text _("Arayüzde gezinin.")
    ...
    hbox:
        label _("Ctrl")
        text _("Basılı tutulduğunda diyaloğu atlar.")

    hbox:
        label _("Tab")
        text _("Diyalog atlama arasında geçiş yapar.")

    hbox:
        label _("Page Up")
        text _("Önceki diyaloğa geri döner.")

    hbox:
        label _("Page Down")
        text _("Sonraki diyaloğa gider.")
    ...
    hbox:
        label "V"
        text _("Yardımcı arasında geçiş yapar {a=https://www.renpy.org/l/voicing}self-voicing{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Sol Tuş")
        text _("Diyaloğu geliştirir ve arayüzü etkinleştirir.")
    ...
    hbox:
        ...
        text _("Önceki diyaloga geri döner.")

    hbox:
        label _("Mouse Wheel Down")
        text _("Sonraki diyaloga geri döner.")
